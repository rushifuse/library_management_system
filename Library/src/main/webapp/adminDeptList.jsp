...
<c:forEach var="b" items="${book}" varStatus="status">
    <tr>
        <td>${b}</td>
        <td>
            <form class="form-container" action="/AdminbookList" method="get" enctype="multipart/form-data">
              <input type="hidden" name="b" value="${b}">
    <button type="submit" class="btn" name="actionType" value="view">View</button>
</form>
