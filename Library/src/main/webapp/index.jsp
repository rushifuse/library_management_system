...
<body>
    ...
    <h2>
        <button type="submit" class="btn-add"><a href="login.jsp">Login</a></button>
        <button type="submit" class="btn-display"><a href="sign_up.jsp">Sign Up</a></button>
        <button type="submit" class="btn-display"><a href="main.jsp">Home Page</a></button>
    </h2>
