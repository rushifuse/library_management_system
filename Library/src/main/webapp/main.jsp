...
<body>
   ...
   <h2>
        ...
        <button type="submit" class="btn-add"><a href="login.jsp">Users</a></button>
        </form>
        
        <form action="adminLoginPage" method="get" enctype="multipart/form-data">
        <button type="submit" class="btn-display"><a href="sign_up.jsp">Admin</a></button>
        </form>
        
    </h2>
    
    <img alt="" src="/img/book-removebg-preview.png" height="250px" width="300px"/>
