        ...
        <h1>Update Student Details</h1>
             ...
             <br>
                ...
                <div class="column" style="animation: slideInLeft 1s ease-out;">
                    ...
                    <form action="updateStudent" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text"  name="password" value="${student.password}" required>
						 ...
						 <label for="studentEmail">Dept Name:</label>
                        <input type="text"  name=" dept" value="${student.dept}" required>
                        
                         <label for="studentEmail">Upload Image:</label>
                        <input type="file"  name=" image"  >
                        
                        <button type="submit" class="btn" name ="update" value="update">Update Book</button>
                    </form>
                </div>
            </div>
      		...
      		<c:if test="${not empty msg}">
      			...
      			<button type="submit" class="btn" name = "back" value= "back"><a href="login.jsp">Back<a></button>
      			
      		</c:if>
				      <form action="back1" method="get"  enctype="multipart/form-data">
				      <button type="submit" class="btn" name="back" value="back"  style="margin-bottom: 700px ; border: 2px solid black">Back</button>
				      </form>
    </div>
</body>
</html>
