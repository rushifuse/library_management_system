    ...
    <div class="table-container">
        <!-- Search Bar -->
         <div class="search-container">
            <input type="text" id="searchInput" onkeyup="searchDepartment()" placeholder="Search by  name...">
        </div>
...
<c:forEach var="b" items="${book}" varStatus="status">
    <tr>
        <td>${b}</td>
                ...
                <form action="studentPurchaseList" method="get" enctype="multipart/form-data">
                <input type="hidden" name="book_name" value="${b}">
                <button type="submit" class="btn" name="b1" value="Purchase" >
                    Purchased Student 
                </button>
                </form>
            ...
            <form action="studentWantTosubmit" method="post" enctype="multipart/form-data">
            <button type="submit" class="btn" name="b1" value="view">
                Submit Student
            </button>
            </form>
